...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_BASE] = {
    ...
    { LC_F20,  OLCAG,   FNL,     XXXXXXX, XXXXXXX, XXXXXXX, W_SP,    XXXXXXX, XXXXXXX, XXXXXXX, C_CAPS,  LSA_P,   KC_RGUI, KC_LALT, }, },
    /*------------------------------------------------------------------------------------------------------------------------------*/
  [_NUM]  = {
    { KC_TAB,  KC_1,    KC_2,    KC_3,    KC_PEQL, _______, _______, _______, _______, _______, _______, _______, _______, _______, },
    ...
    /*------------------------------------------------------------------------------------------------------------------------------*/
  [_CON]  = {
    { _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, RGB_TOG, RGB_VAD, RGB_VAI, _______, },
    ...
    { KC_LCTL, KC_LGUI, C_ST,    XXXXXXX, XXXXXXX, XXXXXXX, _______, XXXXXXX, XXXXXXX, XXXXXXX, KC_LCTL, KC_RALT, KC_LALT, KC_RGUI, }, },
    /*------------------------------------------------------------------------------------------------------------------------------*/
  [_FN]   = {
    { KC_TAB,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_AMPR, },
    ...
    { KC_LSFT, XXXXXXX, C_PRIOR, C_NEXT,  A_LEFT,  A_RIGHT, _______, _______, _______, _______, KC_INS,  KC_DEL,  XXXXXXX, _______, },
    { KC_LCTL, KC_LGUI, KC_LALT, XXXXXXX, XXXXXXX, XXXXXXX, KC_SPC,  XXXXXXX, XXXXXXX, XXXXXXX, KC_LCTL, KC_RALT, KC_LALT, KC_RGUI, }, },
    /*------------------------------------------------------------------------------------------------------------------------------*/
  [_SYMBOL]={
